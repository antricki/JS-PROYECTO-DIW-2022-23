...
<body> 
    ...
    <div class="row">
        ...
        <div class="col-lg-6 col-md-6" id="info">
            ...
            <div class="row">
                <div class="col"> <h5>Composición del material</h5> </div>
                <div class="col">52% Algodón, 48% Poliéster</div>
                <div class="w-100"></div>
                <div class="col"><h5>Instrucciones</h5></div>
        ...
        <div class="aside col-lg-2 col-md-12">
            <p class="precio">15,95€</p>
            <p>Entrega GRATIS el lunes, 26 de septiembre en pedidos superiores a 29€. <h5 class="enStock">En Stock</h5></p>

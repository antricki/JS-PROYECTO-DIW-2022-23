...
<head>
    ...
    <title>¿Cuánto tardaré en recibir mi pedido?</title>
...
<body>
    ...
    <main class="informacion">
        <div>
            <h1 class="title">Devoluciones y reembolsos</h1>
            <ul class="lista__preguntas">
                <li class="title_lista">Elige un tema:</li>
                <li><a href="#devolver">¿Cómo puedo devolver un artículo?</a></li>
                <li><a href="#reembolsos">Reembolsos</a></li>
                <li><a href="tardar">¿Cuánto tardarán en procesar el reembolso?</a></li>
                <li><a href="defectuoso">¿Qué ocurre si recibo un artículo defectuoso?</a></li>
                <li><a href="factura">¿Mi factura no se envía junto con el pedido?</a></li>
            </ul>
        </div>
        <div>
        ...
        <h2 class="title" id="tardar">¿Cuánto tardarán en procesar el reembolso?</h2>
            ...
            Los artículos comprados en el Apple Online Store que lleguen dañados o sean incorrectos se pueden devolver en cualquier Apple Store del mismo país 
            o a través de Atención al Cliente.</p>

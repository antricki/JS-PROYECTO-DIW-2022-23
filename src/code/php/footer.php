    ...
    <div class="container">
        <div class="row footer-up">
            <div class="col-md-4 contacto mb-xs-4">
                ...
                <a href="https://facebook.com/agrariafpcheste/"><img src="../../assets/icons/facebook.svg" alt=""></a>
                <a href="mailto:dptoinformatica@fpcheste.com"><img src="../../assets/icons/mail.svg" alt=""></a>
                <a href="https://github.com/antricki/PROYECTO-DIW-2022-23/"><img src="../../assets/icons/github.svg" alt=""></a>
            </div>

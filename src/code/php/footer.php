    ...
    <div class="container">
        <div class="row footer-up">
            <div class="col-md-4 contacto mb-xs-4">
                ...
                <a href="https://facebook.com/agrariafpcheste/"><img src="<?php echo $dir . 'assets/icons/facebook.svg'?>" alt=""></a>
                <a href="mailto:dptoinformatica@fpcheste.com"><img src="<?php echo $dir . 'assets/icons/mail.svg'?>" alt=""></a>
                <a href="https://github.com/antricki/PROYECTO-DIW-2022-23/"><img src="<?php echo $dir . 'assets/icons/github.svg'?>" alt=""></a>
            </div>
            <div class="col-md-8 pags">
                ...
                <a href="https://familia.edu.gva.es/wf-front/myitaca/login_wf?idioma=C"><img src="<?php echo $dir . 'assets/icons/itaca.png'?>" alt=""></a>
                <a href="https://aules.edu.gva.es/fp/login/index.php"><img src="<?php echo $dir . 'assets/icons/aules.png'?>" alt=""></a>
                <a href="https://portal.edu.gva.es/cvtic/es/herramientas/"><img src="<?php echo $dir . 'assets/icons/TICgva.png'?>" alt=""></a>
            </div>
        </div>
